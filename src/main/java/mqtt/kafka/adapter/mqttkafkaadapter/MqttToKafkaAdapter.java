...
import static mqtt.kafka.adapter.mqttkafkaadapter.util.Constants.AVAILABLE_TOPICS;
import static mqtt.kafka.adapter.mqttkafkaadapter.util.Constants.COMMA_DELIMITER;

import jakarta.annotation.PostConstruct;
import lombok.extern.slf4j.Slf4j;
import mqtt.kafka.adapter.mqttkafkaadapter.kafka.producer.KafkaMessageProducer;
import mqtt.kafka.adapter.mqttkafkaadapter.model.Topic;
import mqtt.kafka.adapter.mqttkafkaadapter.repository.TopicRepository;
